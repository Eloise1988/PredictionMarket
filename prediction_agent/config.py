...
class Settings(BaseSettings):
    ...
    finance_passed_pool_size: int = Field(default=60, alias="FINANCE_PASSED_POOL_SIZE")
    diversify_markets: bool = Field(default=True, alias="DIVERSIFY_MARKETS")
    ...
    cross_venue_llm_verifier_enabled: bool = Field(default=True, alias="CROSS_VENUE_LLM_VERIFIER_ENABLED")
